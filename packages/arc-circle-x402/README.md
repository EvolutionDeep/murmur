...
It is battle-tested in production: [murmur](https://www.muros.live) settles its paid-signal product **Arc Pulse** through Circle on **Arc mainnet** (keyless), alongside a growing autonomous economy of neural agents (24 genesis, breeding toward 48) and tens of thousands of real USDC settlements to date (see [api.muros.live/history](https://api.muros.live/history)).
